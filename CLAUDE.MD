...
- **Consolidation:** Specs ready (`.kiro/specs/knowledge-graph-consolidation/*`), DuplicateDetector/EntityMerger/ConsensusScorer defined but integration with Postgres/Neo4j not complete.
